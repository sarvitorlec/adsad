...
function setup() {
  ...
  gameObjects = [
    ...
    { type: "ground", x: 0, y: 300, w: 600, h: 100, fill: [34, 139, 34] }, // Земля
    { type: "pit", x: 450, y: 300, w: 50, h: 50, fill: [0, 0, 0] }, // Яма
    { type: "tree_trunk", x: 150, y: 250, w: 20, h: 50, fill: [139, 100, 19] },
    { type: "tree_crown", x: 160, y: 230, w: 60, h: 60, fill: [25, 220, 25] },
...
function keyPressed() {
  if (!isFalling) {
    if (keyCode === 32 && !isJumping && gameChar_y === 280) { // Space
      isJumping = true;
      velocityY = jumpSpeed;
      charState = "jumpForward";
    }
